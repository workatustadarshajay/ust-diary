...
type Action = "start" | "guided" | "improve" | "organize" | "create-template" | "convert-template" | "recommend-template";
type Props = { editor: Editor | null; onSaveTemplate: (template: { name: string; description: string; category: string; content: string }) => void };
...
export default function AIWritingCompanion({ editor, onSaveTemplate }: Props) {
